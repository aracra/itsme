...
// 💖 토너먼트 질문 데이터 (수정됨: 비교식 및 스탯 매칭 강화) 💖
// type: 0:지성, 1:센스, 2:멘탈, 3:인성, 4:텐션, 5:광기 (STAT_MAP 기준)
window.questions = [
    // 0: 지성 (Intelligence) - (1. 인지 및 지능: 추론, 전략적 사고, 문제 해결 능력)
    { id: 101, text: "정보가 부족한 복잡한 문제에 직면했을 때, 당황하지 않고 핵심을 짚어 해결책을 도출해내는 사람은?", type: 0 },
    { id: 102, text: "새로운 기술이나 어려운 개념을 설명서 없이도 혼자서 빠르게 터득하고 응용하는 사람은?", type: 0 },
    { id: 103, text: "단기적인 이익보다 5년 후, 10년 후의 미래를 더 치밀하게 예측하고 계획을 세우는 사람은?", type: 0 },
    { id: 104, text: "토론이나 논쟁 상황에서 감정에 휘둘리지 않고 논리적인 근거로 상대방을 설득하는 사람은?", type: 0 },
    { id: 105, text: "일상 속의 사소한 정보나 데이터들을 연결하여 아무도 보지 못한 패턴이나 규칙을 찾아내는 사람은?", type: 0 },

    // 1: 센스 (Sense/Wit) - (2. 정서, 3. 대인 관계: 유머 감각, 사회적 통찰력, 미적 감수성)
    { id: 201, text: "어색한 회식 자리나 미팅에서 절묘한 타이밍에 적절한 유머를 구사하여 분위기를 살리는 쪽은?", type: 1 },
    { id: 202, text: "선물을 고를 때, 상대방이 말로 요청하지 않은 '진짜 원하는 것'을 캐치하여 만족도를 극대화하는 쪽은?", type: 1 },
    { id: 203, text: "새로운 식당이나 여행지를 선택할 때, 실패 확률이 적고 감각적인 분위기를 더 잘 고르는 사람은?", type: 1 },
    { id: 204, text: "상황에 맞는 드레스 코드나 소품을 활용하여 자신의 매력을 돋보이게 하는 데 더 능숙한 사람은?", type: 1 },
    { id: 205, text: "최신 유행이나 트렌드를 남들보다 앞서 파악하고 자신만의 스타일로 빠르게 소화하는 사람은?", type: 1 },

    // 2: 멘탈 (Mental Strength) - (2. 정서, 5. 적응력: 정서적 안정성, 회복 탄력성, 스트레스 인내력)
    { id: 301, text: "오랫동안 공들인 프로젝트가 실패했을 때, 감정 소모 없이 털어버리고 곧바로 다음 계획을 실행하는 사람은?", type: 2 },
    { id: 302, text: "자신을 향한 비판이나 악플에도 휘둘리지 않고 평정심을 유지하며 자기 일을 해내는 사람은?", type: 2 },
    { id: 303, text: "스트레스가 극심한 마감 직전에도 오히려 능률이 올라 침착하게 최종 결과물을 완성하는 사람은?", type: 2 },
    { id: 304, text: "주변에서 큰 싸움이나 갈등이 일어날 때, 냉정하게 중심을 잡아 현명한 중재안을 제시하는 쪽은?", type: 2 },
    { id: 305, text: "예상치 못한 경제적/개인적 역경에도 좌절하지 않고 꿋꿋하게 다시 일어나는 회복 탄력성이 더 강한 사람은?", type: 2 },

    // 3: 인성 (Character/Integrity) - (4. 행동, 7. 성격: 책임감/신뢰도, 정직성/성실함, 배려심)
    { id: 401, text: "자신에게 불이익이 있더라도, 한 번 뱉은 약속이나 말은 철저하게 지켜내는 신뢰도가 더 높은 사람은?", type: 3 },
    { id: 402, text: "타인의 뒷담화나 편견에 동참하지 않고, 모두에게 공평하고 진실된 태도로 대하는 사람은?", type: 3 },
    { id: 403, text: "힘든 상황에 놓인 사람에게 동정보다 실질적인 도움을 먼저 제안하는 배려심이 깊은 쪽은?", type: 3 },
    { id: 404, text: "공동의 목표를 위해 자신의 의견이나 이득을 희생하면서까지 팀워크를 우선시하는 사람은?", type: 3 },
    { id: 405, text: "화가 나는 순간에도 감정적으로 폭발하지 않고 상대방의 입장을 먼저 생각하며 대화하는 사람은?", type: 3 },

    // 4: 텐션 (Energy/Vibe) - (7. 성격, 2. 정서: 활동 수준/활력, 긍정성/낙관성)
    { id: 501, text: "모임에 들어서는 순간, 주변 사람들에게 활기를 불어넣고 분위기를 180도 전환시키는 에너지를 가진 사람은?", type: 4 },
    { id: 502, text: "힘든 일이 생겨도 금세 잊고, 언제나 밝고 긍정적인 태도로 내일을 기대하는 낙관성이 강한 사람은?", type: 4 },
    { id: 503, text: "새로운 사람들과 빠르게 친해지고 모임의 어색한 분위기를 유쾌하게 이끌어가는 사교성이 뛰어난 사람은?", type: 4 },
    { id: 504, text: "좋아하는 일이나 취미에 대해 이야기할 때, 지치지 않고 가장 뜨겁고 열정적으로 몰입하는 사람은?", type: 4 },
    { id: 505, text: "여행, 작업, 놀이 등 모든 활동에서 가장 오래 지치지 않고 활력을 유지하는 지구력이 강한 사람은?", type: 4 },

    // 5: 광기 (Eccentricity/Uniqueness) - (6. 창의성 및 탐구심: 독창성/참신함, 관습 타파 성향)
    { id: 601, text: "남들이 생각하지 못한 독특하고 기발한 아이디어를 현실로 만들기 위해 거침없이 실행에 옮기는 사람은?", type: 5 },
    { id: 602, text: "평범한 대화 주제라도 자신만의 엉뚱한 해석과 상상력을 더해 예측 불가능한 재미로 끌고 가는 사람은?", type: 5 },
    { id: 603, text: "규칙이나 기존 관습에 얽매이지 않고, 자신만의 자유분방한 방식으로 문제를 해결하는 창의성이 강한 사람은?", type: 5 },
    { id: 604, text: "자신만의 특이하고 독자적인 취미나 세계관을 가지고 있어 남다른 매력을 발산하는 사람은?", type: 5 },
    { id: 605, text: "패션, 취향 등 모든 면에서 남들의 시선에 얽매이지 않고 자신만의 개성을 밀어붙이는 사람은?", type: 5 }
];
